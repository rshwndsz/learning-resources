...
* [EE263: Introduction to Linear Dynamical Systems @ Stanford (2014)](https://www.youtube.com/playlist?list=PL06960BA52D0DB32B)

### §1.2 Probability

* Introduction to Probability, Tsitsiklis
* [STAT 110: Probability @ Harvard (2018)](https://www.youtube.com/playlist?list=PL2SOU6wwxB0uwwH80KTQ6ht66KWxbzTIo)
* [6.041: Probabilistic System Analysis & Applied Probability @ MIT (Fall 2010)](https://www.youtube.com/playlist?list=PLUl4u3cNGP61MdtwGTqZA0MreSaDybji8)
* [Probability: The science of uncertainty and data - EdX by MIT (2020)](https://www.edx.org/course/probability-the-science-of-uncertainty-and-data?utm_source=ocwprod-mit-opencourseware&utm_medium=affiliate_partner?utm_source=OCW&utm_medium=CHP&utm_campaign=OCW)
* [RES 6.012: Introduction to Probability @ MIT (Spring 2018)](https://www.youtube.com/playlist?list=PLUl4u3cNGP60hI9ATjSFgLZpbNJ7myAg6)
...
* [Introduction to Statistical Learning](http://www-bcf.usc.edu/~gareth/ISL/) 
   * [Videos](https://www.youtube.com/playlist?list=PLOg0ngHtcqbPTlZzRHA2ocQZqB1D_qZ5V)
...
* Python Data Science Handbook by Jake Vanderplass
...
* [Mathematics for Machine Learning, Deisenroth et.al](https://github.com/mml-book/mml-book.github.io)
...
* [Basic Linear Regression from scratch](https://www.kaggle.com/aakashns/pytorch-basics-linear-regression-from-scratch)
* [Full Preprocessing Tutorial](https://www.kaggle.com/gzuidhof/full-preprocessing-tutorial)
* [Simple LSTM - PyTorch Version](https://www.kaggle.com/bminixhofer/simple-lstm-pytorch-version)
* [PyTorch Whale Identifier (pretrained model)](https://www.kaggle.com/aakashns/pytorch-basics-linear-regression-from-scratch)
* [Baseline UNet in PyTorch](https://www.kaggle.com/windsurfer/baseline-u-net-on-pytorch)

#### §4.3 Articles

* [Training your own cnn using pytorch - Kaggle](https://www.kaggle.com/puneetgrover/training-your-own-cnn-using-pytorch)
* [Training convolutional neural networks to categorize clothing with pytorch - TDS](https://towardsdatascience.com/training-convolutional-neural-networks-to-categorize-clothing-with-pytorch-30b6d399f05f)
* [CNNs in Pytorch - Alogorithmia blog](https://blog.algorithmia.com/convolutional-neural-nets-in-pytorch/)
...
* CSC321: Intro to Neural Networks & ML by Geoffrey Hinton @ UofToronto
...
### §5.3 Core Papers
- Optimisation
    - Adam: A Method for stochastic optimisation, Kingma & Ba 2014
    -  Dropout: A simple way to prevent neural networks from overfitting, Srivastava & Hinton et.al 2014
    - Batch Normalisation: Accelerating deep network training by reducing internal covariate shift, Ioffe et.al 2015
    - AdamW: Decoupled weight decay regularisation, Loshchilov & Hutter 2017
    - Super-Convergence: Very fast training of Neural Networks using Large learning rates, Smith et.al 2017
...
- Classification
    ...
    - InceptionV3: Rethinking the Inception Architecture for Computer Vision, Szegedy et.al 2015
    ...
    - Searching for MobileNetV3, Howard & Sandler et.al 2019
- Detection
    - Faster R-CNN: Towards Real-Time Object Detection with Region Proposal Networks, Ren et.al 2015
    - YOLO: You Only Look Once - Unified, Real-Time Object Detection, Redmon et.al 2015
    - SSD: Single Shot MultiBox Detector, Liu et.al 2015
    - FPN: Feature Pyramid Networks for object detection, Lin & Girshick et.al 2017
...
- Segmentation
    ...
    - DeepLabV3: Rethinking atrous convolution for semantic image segmentation, Chen et.al 2017
    - U-Net: Convolutional Networks for Biomedical Image Segmentation, Ronnenberger et.al 2015
    - Mask R-CNN, He et.al 2017
- Attention & Transformers 
    - Neural Machine Translation by Jointly Learning to Align & Translate, Bahdanau et.al 2014
